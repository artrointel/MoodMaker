...
open class RectRenderer : RendererBase(), IRendererProjectionListener, IRendererTransformListener {
    ...
    override fun onInitializeGLObjects(): Array<IGLObject> {
        val vShader = Shader(
            Shader.TYPE.VERTEX,
            Assets.getShaderString("base.vsh.glsl"))
        val fShader = Shader(
            Shader.TYPE.FRAGMENT,
            Assets.getShaderString("base.fsh.glsl"))
