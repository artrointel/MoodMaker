...
class SphereUnwrapRenderer(bufferFromImage: Buffer, width: Int, height: Int)
    ...
    override fun onInitializeGLObjects(): Array<IGLObject> {
        val vShader = Shader(
            Shader.TYPE.VERTEX,
            Assets.getShaderString("transition_sphere.vsh.glsl"))
        val fShader = Shader(
            Shader.TYPE.FRAGMENT,
            Assets.getShaderString("transition_sphere.fsh.glsl"))
        ...
        val uTexture = Texture(program, "tex", buffer, width, height, true)
