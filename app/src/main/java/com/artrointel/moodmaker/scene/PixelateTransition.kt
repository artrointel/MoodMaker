...
class PixelateTransition (world: RenderWorldBase) : DemoTransition(world) {
    var node = Node3D()
    lateinit var renderer : PixelateRenderer
    ...
    override fun onInitialize() {
        ...
        renderer = PixelateRenderer(imageInfo.buffer, imageInfo.width, imageInfo.height)
